...
MAIN_MODAL = {
	...
	"blocks": [
		{ "type": "section", "text": { "type": "mrkdwn", "text": "Please select an operation type and input prompt (*max chars = 3000*):" } },
		{ "type": "input", "element": {
		        "type": "static_select",
		        ...
		        "option_groups": [
					{
        				...
        				"options": [
        				    { "text": { "type": "plain_text", "text": "Freestlye Prompt / открытый текст / Dowolny tekst", "emoji": True }, "value": "none" },
		...
		{   "type": "input",
		    ...
		    "label": { "type": "plain_text", "text": "Text / Email Content / Code" }
		}
	]
}
